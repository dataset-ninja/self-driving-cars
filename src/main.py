...
PROJECT_NAME_FULL = "Self Driving Cars"
sly.logger.info(f"Working on project: {PROJECT_NAME}, full name: {PROJECT_NAME_FULL}")
...
custom_data = {
    ...
    "preview_image_id": 235085,
    "github_url": "https://github.com/dataset-ninja/self-driving-cars",
    "github": "dataset-ninja/self-driving-cars",
    "citation_url": None,  # ! Not sure
    "download_sly_url": download_sly_url,
    #####################
    # ? optional fields #
    #####################
    "download_original_url": "https://www.kaggle.com/datasets/kumaresanmanickavelu/lyft-udacity-challenge/download?datasetVersionNumber=1",
    # "paper": None,
